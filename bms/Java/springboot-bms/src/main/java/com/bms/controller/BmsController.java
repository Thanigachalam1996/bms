...
public class BmsController {
	...
	@PutMapping(value="/api/register/{registeredId}")
	public ResponseEntity<CustomerList> updateCustomer(@PathVariable int registeredId,@RequestBody CustomerList customer){
		CustomerList bmsAuthNew = bmsAuthService.customerUpdate(registeredId,customer);
